...
td.overflowed, th.overflowed {
        background-image: url(/coins/devstage/20231027115302/skin/v1105/images/ellipsis.svg);
...
/* Styled selectors */
.styled-select{
    background-image: url(/coins/devstage/20231027115302/skin/v1105/images/down_arrow.svg);
...
.styled-select select{
    /*background-image: url(/coins/devstage/20231027115302/skin/v1105/images/input_underline.jpg);*/
    background-image: 
...
INPUT.error, TEXTAREA.error, SELECT.error, .ui-multiselect.error {
    background-image: url(/coins/devstage/20231027115302/skin/v1105/images/error_underline.svg);
    background-size: 5000px 2px;
}
...
td.headertitle li.link:hover span:after
{
    ...
    top: 0;
    content: '';
    background-image: url(/coins/devstage/20231027115302/skin/v1105/images/breadcrumbs_arrow.svg);
...
td.headertitle li:after{
    ...
    top: 0;
    content: '';
    background-image: url(/coins/devstage/20231027115302/skin/v1105/images/breadcrumbs_arrow.png);
    background-repeat: no-repeat;
*/}
...
div.hplinks ul li:before {
    ...
    height: 2em; 
    width: 1.5em;
    content: url(/coins/devstage/20231027115302/skin/v1105/images/favourites.svg);
    vertical-align: middle;
}
...
H1.print{
    color: #f47322;
    font-size: 24pt;
    background-image: url(/coins/devstage/20231027115302/skin/v1105/images/COINS_banner_logo.png);
    background-position:top right;
    background-repeat:no-repeat;
...
div.sectionbarbtn {
    width: 45px;
    height: 45px;
    background-image: url(/coins/devstage/20231027115302/skin/v1105/images/task_arrows.png);
