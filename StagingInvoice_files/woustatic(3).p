...
#logo .client-logo img.client {
    padding-left: 0;
}

#logo .client-logo:before {
    content: '';
    position: absolute;
    top: 0;
    left: 12px;
...
.styled-select:has(div.dd-container) {
    overflow: visible;
}
...
button.image-button, input[type='button'], input[type='submit']  {
    border-width: 1px;
    border-radius: 2px;
    width: 24px;
    height: 24px;
...
td.filter td.formselectiondata {
    display: inline-flex;
}
...
input.nextgreen, input.nextgreen:focus, button[class~='text-image-button'][class~='nextgreen'] {
    color: #2a2a2a;
    outline: none;
}
...
/* don't want open button on multi select */
div.styled-select .ui-multiselect-open {
    display:none;
}
/* don't allow multi select options to spill - 2nd span (no class) of button */
...
/* palette colours */
.backgroundemphasise1{background-color: rgba(42,42,42,0.06) !important; color:#2a2a2a !important;}
.backgroundemphasise2{background-color: rgba(42,42,42,0.12) !important; color:#2a2a2a !important;}
.backgroundemphasise3{background-color: rgba(42,42,42,0.18) !important; color:#2a2a2a !important;}
.backgroundnormal{background-color: #ffffff !important; color:#2a2a2a !important;}
.backgroundaccent{background-color: #4a4a4a !important; color:#ffffff!important;}
.backgroundhighlight{background-color: rgba(66,73,88,0.1) !important; color:#2a2a2a !important;}
.backgroundalert{background-color: #e54d42 !important; color:#ffffff!important;}
.backgroundwarning{background-color: #fbac09 !important; color:#ffffff!important;}
.backgroundsuccess{background-color: #40b915 !important; color:#ffffff!important;}

.textnormal{color:#2a2a2a !important;}
.textaccent{color:#ffffff !important;}
.textmuted{color:#767676 !important;}
.texterror{color:#ed0034 !important;}
.textwarning{color:#b26200 !important;}
.textsuccess{color:#368700 !important;}
.textanchor{color:#2a2a2a !important;} 
