...
var bClickFunctionOnHighlight = false;
var fAfterClick=null;
...
function highlightThisFunction(pcCode) {
  ...
  for (i=0;i<hLinks.length;i++) {
    ...
    if (lcTreeCode==pcCode) {
      ...
      if(bClickFunctionOnHighlight==true) lhAnchor.click();
      bClickFunctionOnHighlight=false;
      break;;
    }
  }
  if(lbFound && typeof fAfterClick == "function") {
    fAfterClick();
    fAfterClick=null;
  }
  return lbFound;
}
function highlightFunction(pcCode,pfAfterClick) {
  fAfterClick=pfAfterClick;
