...
div#searchSort {
    background-image: url(/coins/devstage/20230228063043/skin/v1105/images/select-arrow.png);
...
div.taskbarbtn {
    ...
    background-repeat: no-repeat;
    float: left;
    background-image: url(/coins/devstage/20230228063043/skin/v1105/images/menu_closed.svg);
}

div.taskbar.open div.taskbarbtn {
    background-image: url(/coins/devstage/20230228063043/skin/v1105/images/menu_open.svg);
}
