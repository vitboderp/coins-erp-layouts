      ...
      switch(lcSize) {
        case 'alert':
          ...
          lcHTML+='<div class="cds-card__info">'
                 ...
                 + '>' + htmlEncode(lhData.getAttribute('data-title')) + '</div>'
                 + '<div class="cds-card__value">'
                 + '<span class="cds-card__bullet" style="background-color:' + htmlEncode(lcColour) + ';"></span>'
                 +'<span title="' + htmlEncode(lcLabel) + '">' + htmlEncode(lcValue) + '</span>'
                 + '</div>'
                 +'</div>';
          ...
          lcHTML = '<div class="cds-tile__icon cds-circle-icon cds-circle-icon--sm"'
                 + ((lcColour)?' style="background:' + htmlEncode(lcColour) + ';'
                 + 'color:' + lcText + ';'
                 + '"':'')
                 + '>'
                 + '<i class="'
                 ...
                 + '"></i>'
                 + '</div>'
                 + '<div class="cds-tile__title">' + htmlEncode(lhData.getAttribute('data-title')) + '</div>' 
                 + '<div class="cds-tile__value" title="' + htmlEncode(lcLabel) + '"'
                 + '>' + htmlEncode(lcValue) + '</div>';
        ...
        default:
          lcHTML+='<div class="cds-card__info">'
                 +'<div class="cds-card__subtitle"'
                 + ((lcSize=="nolabel")?' style="display:none"':'')
                 + '>' + htmlEncode(lcLabel) + '</div>'
                 +'<div class="cds-card__value"'
                 + ' style="'
                 + ((lcColour)?'color:' + htmlEncode(lcColour) + ';':'')
                 + '">' + htmlEncode(lcValue) + '</div>'
                 +'</div>'
          $(lhData).find('div.cds-card__header').show();
          $(lhData).removeClass('cds-tile').addClass('cds-card--single');
        ...
        case 'small':
          lcHTML+='<span class="value'
                 ...
                 +'" title="' + htmlEncode(lcLabel) + '">'
                 + htmlEncode(lcValue) + '</span>';
          break;
        case 'alert':
          lcHTML = '<div class="cds-tile__icon">'
                 ...
                 + '"></i>'
                 + '</div>'
                 + '<div class="cds-tile__title">' + htmlEncode(lcLabel) + '</div>' 
                 + '<div class="cds-tile__value">' + htmlEncode(lcValue) + '</div>';
          break;
        default:
          if(lcValues.length==3)
          lcHTML+='<span class="value single">'
                 +htmlEncode(lcValue) + '</span><br>'
                 +'<span class="label">'
                 +htmlEncode(lcLabel) + '</span>';
          else
